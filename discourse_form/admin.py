...
from .models import Discourse_form,Form_answer,Answered_subject,Answered_skill,Answered_axis,Answered_learning_goal,Answered_copus_code,Answered_axis_phrases
...
admin.site.reigster(Answered_axis_phrases)
